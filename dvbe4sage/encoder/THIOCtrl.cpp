...
BOOL CBDAFilterGraph::THBDA_IOCTL_SET_PID_FILTER_INFO_Fun(VOID)
{
	BOOL bResult	= FALSE;
	DWORD   nBytes  = 0;
...
BOOL CBDAFilterGraph::THBDA_IOCTL_GET_PID_FILTER_INFO_Fun(VOID)
{
	BOOL bResult	= FALSE;
	DWORD   nBytes  = 0;
	PID_FILTER_INFO PidInf; 
...
BOOL CBDAFilterGraph::THBDA_IOCTL_GET_LNB_DATA_Fun()
{	
	BOOL bResult	= FALSE;
	DWORD   nBytes  = 0;	
...
BOOL CBDAFilterGraph::THBDA_IOCTL_CI_SEND_PMT_Fun(PBYTE pBuff, BYTE byBuffSize)
{
    BOOL bResult = FALSE;
    DWORD nBytes = 0;
