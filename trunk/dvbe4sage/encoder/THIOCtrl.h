...
//InBuffer      : struct THMMIInfo
//InBufferSize  : sizeof(THMMIInfo) bytes
//OutBuffer     : NULL
//OutBufferSize : 0 bytes
//*******************************************************************************************************
...
typedef struct {
    ...
    DWORD   dwIoControlCode;    // 4 operation
    LPVOID  lpInBuffer;         // 4 input data buffer
    DWORD   nInBufferSize;      // 8 size of input data buffer
    LPVOID  lpOutBuffer;        // 4 output data buffer
...
typedef struct _DriverInfo 
{
    ...
    DWORD           SimuType;                // 0: Physical, 1: Virtual DVB-S, 2: Virtual DVB-T, 4: Virtual DVB-C, 8: Virtual ATSC
    CHAR            Reserved[184];
...
typedef struct _DEVICE_INFO
{
    ...
    UCHAR           MAC_ADDRESS[6];
    UCHAR           CI_Support;             // SUPPORT_CI | UNSUPPORT_CI
