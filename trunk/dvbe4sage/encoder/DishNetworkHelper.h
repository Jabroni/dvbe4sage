...
int CDishDecode::get_bit( int bit_index, const unsigned char *byteptr )
{
    int byte_offset;
   int bit_number;
...
//
unsigned int CDishDecode::get_bits( int bit_index, int bit_count, const unsigned char *byteptr )
{
   int i;
    unsigned int bits = 0;
...
//
unsigned char *CDishDecode::Decompress(const unsigned char *compressed, int length, int table)
{
   int            i;
   int            total_bits;
   int            current_bit = 0;
